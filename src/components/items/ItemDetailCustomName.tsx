...
interface ItemDetailCustomName {
    customerCode?: string
    navigation?: any;
    onPressItem: any;
    codeOrder: string;
...
export const ItemDetailCustomName = (props: ItemDetailCustomName) => {
    const [showIcon, setShowIcon] = useState(false)
    const { PhoneNumBer, customerCode, titleAcpect, onPressTransposition, onPressReturn, index, onPressApply, onPressAcept, onPressGet, onPressIcon, type, Reload, SaleVoiceID, styleItem, navigation, Option, onPressItem, codeOrder, invoiceWeight, dateTime, nameCustomer, addressCustomer, noteOder, sourceIcon, typeItem } = props
    ...
    return (
        <Card style={[styles.container, styleItem]}>
            <Ripple
                ...
                <View style={[styles.item, styleItem]}>
                    ...
                    <View style={styles.header2}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingRight: 8, height: hp(4.5), alignItems: 'center' }}>
                            <Text
                                style={{
                                    fontSize: wp(4),
                                    color: 'black',
                            ...
                            {typeItem == true ? <Ripple onPressIn={onPressIcon}><Image source={sourceIcon} style={{ height: hp(3.3), width: hp(3.3), resizeMode: 'contain' }}></Image></Ripple> : <View></View>}
                        </View>
                    </View>
            ...
            {showIcon == true ? <View style={styles.bottom}>
                <IconDetailCustom
                    iconShow={true}
                ...
                {Option == '7' ? <IconDetailCustom
                    iconShow={true}
                    onPress={() => { onPressReturn(SaleVoiceID,index) }}
                    labelStyle={{ color: mainColors.blue, fontSize: wp(3) }}
                    title={'Trả Phiếu'}
